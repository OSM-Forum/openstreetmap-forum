...
else if (isset($_GET['find_user']))
{
	...
	{
		if ($input != '' && in_array($key, array('username', 'email', 'title', 'realname', 'url', 'jabber', 'icq', 'msn', 'aim', 'yahoo', 'location', 'signature', 'admin_note', 'last_visit_ip')))
		{
...
?>
								...
								<tr>
									...
									<td><input type="text" name="form[last_visit_ip]" size="30" maxlength="10" tabindex="14" /></td>
								</tr>
							</table>
						</div>
					</fieldset>
